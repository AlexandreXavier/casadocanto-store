  ...
  return (
    <div className="relative mx-auto bg-white px-4  pb-14 pt-48 text-black lg:px-8">
      <article className="prose prose-slate mx-auto">
        ...
        <p>Effective date: 18/07/2024</p>
        <h3>1. Introduction</h3>
        <p>
          Welcome to <strong>Casa do Canto</strong>.
        </p>
        <p>
          Casa do Canto (“us”, “we”, or “our”) operates{" "}
          <a href="https://casadocanto.pt">https://casadcanto.pt</a> (hereinafter
          referred to as “<strong>Service</strong>”).
        </p>
        <p>
          Our Privacy Policy governs your visit to{" "}
          <a href="https://casadocanto.pt">https://casadocanto.pt</a>, and explains
        ...
        <h3>2. Definitions</h3>
        <p>
          <strong>SERVICE</strong> means the https://casadocanto.pt website
          operated by Casa do Canto.
        </p>
        <p>
        ...
        <h3>5. Use of Data</h3>
        <p>Casa do Canto uses the collected data for various purposes:</p>
        <ol>
        ...
        <p>
          Casa do Canto will take all the steps reasonably necessary to ensure that
        ...
        <ol>
          <li>
            <p>
              <strong>What personal information we have about you</strong>. If
          ...
          <li>
            <p>
              ...
              this request, we will delete the personal information we hold
        ...
        <p>By email: support@Casa do Canto.io</p>
        <p>
        ...
        <p>
          ...
          Service (“ <strong>Service Providers</strong>”), provide Service on
        ...
        <p>
          Plausible Analytics is an analytics service provided by Conva Ventures
        ...
        <p>By email: jalexander.xavier@gmail.com.</p>
      </article>
    </div>
  );
}
