    ...
    <div className="relative mx-auto bg-white px-4  pb-14 pt-48 text-black lg:px-8">
      <article className="prose prose-slate mx-auto">
        ...
        <p>
          ...
          Casa do Canto (“Casa do Canto,” “us,” “we” or “our”) and the party agreeing to
          ...
          the Casa do Canto Terms of Service, Casa do Canto Business Agreement, the
          Casa do Canto Privacy Policy, and any other terms found on the Casa do Canto
          website do not apply to the Casa do Canto Services.
        </p>
        <p>
        ...
        <p>
          Casa do Canto may update the Services from time to time. If Casa do Canto
          changes the Services in a manner that materially reduces their
          functionality, Casa do Canto will notify Customer at the email address
        ...
        <p>
          ...
          Casa do Canto hereby grants to Customer during the Term a limited
        ...
        <p>
          ...
          offered under an open source license, Casa do Canto will make the license
        ...
        <p>
          Casa do Canto may make certain reference Materials, including without
          limitation an NDA, available through the Services. Such Materials are
          for informational purposes only and Casa do Canto makes no representations
        ...
        <h3>1.6 Casa do Canto Rights</h3>
        <p>
          Casa do Canto reserves the right to access Customer’s account as necessary
        ...
        <p>
          ...
          Materials. Casa do Canto does not own, or operate these Third Party
          ...
          access and use; (b) Casa do Canto is not responsible for any act or
        ...
        <p>
          ...
          information will be governed by Casa do Canto Privacy Policy for the
          applicable Services.
        </p>
        <h3>2.2 End Users</h3>
        <p>
        ...
        <p>
          ...
          and provisioning new End User Accounts. Casa do Canto will charge Customer
        ...
        <p>
          ...
          share the Authentication Credentials or, without Casa do Canto’s
        ...
        <p>
          ...
          Casa do Canto in writing of any unauthorized use of your account by
          sending an email to jalexandre.xavier@gmail.com.
        </p>
        ...
        <p>
          ...
          other notices Casa do Canto provides or publishes in connection with the
          Services, and Customer will promptly notify Casa do Canto if it learns of
          ...
          is provided by Casa do Canto for accessing the Services, unless otherwise
          specifically authorized by us in a separate written agreement signed
          by a Casa do Canto authorized signatory.
        </p>
        ...
        <p>
          ...
          content that violates Casa do Canto’s rights or any third party’s rights,
          ...
          consent signed by a Casa do Canto authorized signatory; (g) will not
          ...
          code, whether on Casa do Canto’s or others’ computers or equipment,
        ...
        <p>
          These Terms constitute Customer’s instructions to Casa do Canto to process
          Customer Data. Casa do Canto, Casa do Canto personnel and its Subcontractors
        ...
        <p>
          ...
          Casa do Canto will not be liable for any loss or corruption of Customer
          ...
          wishes to protect transmission of data or files to Casa do Canto.
          Casa do Canto will have no liability to you for any corruption, deletion,
          destruction or loss of any of Customer Data.
        </p>
        <h3>3.3 Aggregate/Anonymous Data</h3>
        <p>
          Casa do Canto may generate data that has been de-identified, anonymized
          ...
          services and features; and conducting and furthering Casa do Canto
          business.
        </p>
        ...
        <p>
          Casa do Canto may transfer Customer Data to and access, use, and store
          ...
          CCPA or the GDPR that Casa do Canto is Processing on Customer’s behalf,
          Customer and Casa do Canto agree to the Casa do Canto Data Processing
          ...
          meanings defined in the Casa do Canto Data Processing Addendum.
        </p>
        <h2>4. Intellectual Property</h2>
        <h3>4.1 Reservation of Rights</h3>
        <p>
          Except as set forth herein, these Terms do not grant: (a) Casa do Canto
          any Intellectual Property Rights in Customer Data; or (b) Customer any
          Intellectual Property Rights in the Services, Materials, or Casa do Canto
        ...
        <p>
          Customer grants Casa do Canto only the limited rights that are reasonably
          necessary for Casa do Canto to deliver the Services in accordance with
        ...
        <p>
          ...
          to us, Customer: (i) assigns to Casa do Canto all of its right, title and
          interest in and to all such Feedback; and (ii) agrees to provide any
          reasonable assistance necessary to document and maintain Casa do Canto’s
          rights in the Feedback. In the event that such assignment is not
          valid, Customer agrees and grants to Casa do Canto a royalty-free,
        ...
        <h3>6.1 Fees</h3>
        <p>
          Customer will pay Casa do Canto or Customer’s reseller all applicable Fees
          ...
          Customer’s reseller. Customer authorizes Casa do Canto, or Customer’s
        ...
        <h3>6.2 Payment</h3>
        <p>
          Customer will pay Casa do Canto invoices on the payment interval set forth
          in the Order Form. Casa do Canto may suspend or terminate the Services if
          Fees are past due. Customer will provide complete and accurate billing
          and contact information to Casa do Canto or to Customer’s reseller.
        </p>
        <h3>6.3 Taxes</h3>
        <p>
          Fees are exclusive of taxes and Customer is responsible for all Taxes.
          Casa do Canto, or Customer’s reseller, will charge Taxes when required to
          do so. If Customer provides Casa do Canto or its reseller with a valid
          exemption certificate, Casa do Canto will not collect the taxes covered by
          that certificate.
        </p>
        <h3>6.4 Withholding Taxes</h3>
        <p>
          Customer will pay Casa do Canto or its reseller net of any applicable
          Withholding Taxes. Customer and Casa do Canto, or Customer’s reseller if
          ...
          Casa do Canto or Customer’s reseller qualifies for a tax exemption, or a
          reduced treaty withholding rate, Casa do Canto or Customer’s reseller will
          provide Customer with reasonable documentary proof. Customer will
          provide Casa do Canto or Customer’s reseller reasonable evidence that it
          has paid the relevant authority for the sum withheld or deducted.
        </p>
        <h3>6.5 Auto-renewals and Trials</h3>
        <p>
          IF CUSTOMER HAS ALREADY PROVIDED A PAYMENT METHOD TO Casa do Canto FOR
          RECURRING CHARGES AND CUSTOMER’S ACCOUNT IS SET TO AUTO-RENEWAL OR IS
          IN A TRIAL PERIOD, Casa do Canto (OR CUSTOMER’S RESELLER) MAY CHARGE
          AUTOMATICALLY AT THE END OF THE TRIAL OR FOR THE RENEWAL, UNLESS
          CUSTOMER NOTIFIES Casa do Canto (OR CUSTOMER’S RESELLER, AS APPLICABLE)
          THAT CUSTOMER WANTS TO DISABLE AUTO-RENEWAL OR CANCEL THE SERVICES IN
          ACCORDANCE WITH SECTION 7.2. Casa do Canto may revise Services rates by
        ...
        <p>
          ...
          a subscription basis. Casa do Canto will deliver the Services to Customer
        ...
        <p>
          ...
          via email to jalexandre.xavier@gmail.com) at least thirty days prior to the
          ...
          and provided a payment method to Casa do Canto for recurring charges,
          Customer may elect to terminate the Terms via the Admin Console prior
          to the day a Renewal Term begins. Casa do Canto reserves the right to
        ...
        <p>
          ...
          Services for purchasing additional Services. Casa do Canto will charge
        ...
        <p>
          ...
          jalexandre.xavier@gmail.com or by following the notice procedures for
          ...
          effect after Casa do Canto processes the cancellation at the conclusion of
          the then-current Services Term.
        </p>
        <h3>8.3 Termination by Casa do Canto</h3>
        <p>
          Casa do Canto may, in its sole discretion, immediately terminate these
        ...
        <p>
          ...
          rights and licenses granted by Casa do Canto to Customer will cease
          immediately. For a period of up to 30 days following termination,
          Casa do Canto may, in its sole discretion, permit Customer to retrieve
          Customer Data from the Services. Casa do Canto may delete Customer Data
          from the Services and Casa do Canto will have no obligation to continue to
          store or permit Customer to retrieve Customer Data. Post-termination
          assistance from Casa do Canto is subject to the mutual agreement of the
          parties, including fees and terms Casa do Canto specifies for such
          assistance.
        </p>
        <h2>9. Representations and Warranties</h2>
        <p>
          Customer represents and warrants to Casa do Canto that: (a) it has full
        ...
        <p>
          ...
          or for unscheduled emergency maintenance, either by Casa do Canto or by
        ...
        <p>
          ...
          PERMITTED BY LAW, EXCEPT AS EXPRESSLY STATED IN THE TERMS, Casa do Canto
          ...
          NON-INFRINGEMENT. Casa do Canto MAKES NO REPRESENTATION, WARRANTY OR
          ...
          UNINTERRUPTED OR ERROR-FREE. Casa do Canto WILL NOT BE RESPONSIBLE OR
          ...
          THIRD PARTY, OR NON-Casa do Canto SERVICES (INCLUDING FOR ANY DELAYS,
        ...
        <p>
          ...
          auditing to which the Services have been subjected; and (e) Casa do Canto
          WILL HAVE NO LIABILITY ARISING OUT OF OR IN CONNECTION WITH BETA
          SERVICES – USE AT YOUR OWN RISK.
        </p>
        <h4>10.3.2 Feedback</h4>
        <p>
          Casa do Canto offers Beta Services in order to get user feedback. In
          exchange for using Beta Services, Customer Agrees that Casa do Canto may
          contact Customer and its End Users to obtain Feedback regarding Beta
          Services.
        </p>
        <h4>10.3.3 Confidential</h4>
        <p>
          Beta Services are confidential until officially launched by Casa do Canto.
          ...
          functionality confidential until officially launched by Casa do Canto.
          Customer may disclose information regarding Beta Services to the
          extent required by law or regulation if Customer gives Casa do Canto
          reasonable advance written notice, to the extent permitted, so
          Casa do Canto can seek to prevent or limit the disclosure.
        </p>
        <h2>11. Limitation of Liability</h2>
        <h3>11.1 Limitation on Indirect Liability</h3>
        <p>
          TO THE FULLEST EXTENT PERMITTED BY LAW, EXCEPT FOR Casa do Canto OR
          CUSTOMER’S INDEMNIFICATION OBLIGATIONS, NEITHER CUSTOMER NOR Casa do Canto
        ...
        <p>
          TO THE FULLEST EXTENT PERMITTED BY LAW, Casa do Canto’S AGGREGATE
          LIABILITY UNDER THE TERMS WILL NOT EXCEED THE AMOUNT PAID BY CUSTOMER
          TO Casa do Canto HEREUNDER DURING THE TWELVE MONTHS PRIOR TO THE EVENT
          GIVING RISE TO LIABILITY. FOR FREE ACCESS SUBSCRIPTIONS OR BETA
          SERVICES, Casa do Canto’S TOTAL LIABILITY WILL NOT EXCEED, IN AGGREGATE,
        ...
        <p>
          ...
          OUT OF OR RELATED TO THESE TERMS, ANY Casa do Canto SERVICES OR ANY
        ...
        <p>
          Customer will indemnify and hold Casa do Canto and its Affiliates harmless
          ...
          reasonable requests to assist Casa do Canto’s defense of such claim, suit
          or demand.
        </p>
        <h2>13. Copyright</h2>
        <p>
          Casa do Canto will terminate the account and access rights of any
          ...
          Millennium Copyright Act Notice at dmca@Casa do Canto.io.
        </p>
        <h2>14. Disputes</h2>
        ...
        <p>
          ...
          Customer or Casa do Canto may bring a formal proceeding.
        </p>
        <h3>14.2 Arbitration</h3>
        <p>
          Customer and Casa do Canto agree to resolve any claims relating to the
          ...
          Casa do Canto’s individual claim(s); the arbitrator may not award relief
        ...
        <p>
          ...
          described above. Both Customer and Casa do Canto consent to venue and
          personal jurisdiction there.
        </p>
        <h3>14.4 NO CLASS OR REPRESENTATIVE ACTIONS</h3>
        <p>
          Customer may only resolve disputes with Casa do Canto on an individual
        ...
        <h3>16.1 Changes</h3>
        <p>
          Casa do Canto may change these Terms from time to time. Customers can
          review the most current version of these Terms at any time at
          https://casadocanto.pt/terms. The revised provisions will become
        ...
        <p>
          ...
          of Casa do Canto. Casa do Canto may assign or transfer these Terms, in whole
          or in part, without restriction.
        </p>
        <h3>16.3 Notices</h3>
        <p>
          Notices must be sent via email. Notices to Casa do Canto must be sent to
          Casa do Canto at jalexandre.xavier@gmail.com.
        </p>
        <h3>16.4 Force Majeure</h3>
        <p>
          Except for payment obligations, neither Casa do Canto nor Customer will be
        ...
        <p>
          ...
          kind to bind Casa do Canto in any respect whatsoever; instead, our
          relationship is that of independent contractors.
        </p>
        <h3>16.7 No Third Party Beneficiaries</h3>
        <p>
          These Terms create no third party beneficiary rights to the Casa do Canto
        ...
        <p>
          Casa do Canto reserves the right to use Customer’s name and logo for
          marketing or promotional purposes on Casa do Canto’s website and in other
          communication with existing or potential Casa do Canto customers.
        </p>
        ...
        <p>
          ...
          elected by Casa do Canto in a particular instance, you expressly agree to
        ...
        <p>
          ...
          Please carefully review our Privacy Policy to understand how Casa do Canto
        ...
        <p>
          “Admin Console” means the online tool provided by Casa do Canto to
        ...
        <p>
          “Fees” means the amounts invoiced to Customer or charged by Casa do Canto
        ...
        <p>
          “Privacy Policy” means the Casa do Canto Privacy Policy available at
          https://casadocanto.pt/privacy.
        </p>
        <p>
          “Provisioning Date” is the date upon which Casa do Canto makes the
        ...
        <p>
          “Services” means the Casa do Canto services, which include: (a) the
          Casa do Canto website (https://casadocanto.pt); (b) the communication
        ...
        <p>
          “Software” means any software provided by Casa do Canto as part of the
          Services, either directly by Casa do Canto or through third party
          distribution channels such as app stores.
        </p>
        <p>
          “Subcontractor” means an entity to whom Casa do Canto subcontracts any of
          its obligations under the Agreement.
        </p>
        <p>
          “Sub-processor” means an entity who agrees to process Customer Data on
          Casa do Canto’s behalf, or on behalf of another Casa do Canto sub-processor,
        ...
        <p>
          ...
          or nature excluding tax that is based on Casa do Canto’s net income,
        ...
        <p>
          ...
          Casa do Canto or Customer’s reseller in which Customer is required by law
          to withhold or deduct on the payment to Casa do Canto or Customer’s
          reseller.
        </p>
      </article>
    </div>
